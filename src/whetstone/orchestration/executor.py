...
ProviderRequestBuilder = Callable[[RolloutWorkRequest], "ProviderCallRequest"]
...
class ExecutorContext:
    ...
    def _assemble_rollout_result(
        ...
        *,
        ...
        terminal_generation = (
            provider_result.generation if provider_result.succeeded else None
        )
        ...
        graph_run_result = GraphRunResult(
            ...
            outcomes={outcome.node_id: outcome for outcome in node_outcomes},
        ...
        *,
        ...
        if terminal_generation is not None:
            llm_outcome = NodeOutcome.success(
                ...
                output=NodeOutput(values={"text": terminal_generation.text}),
            )
