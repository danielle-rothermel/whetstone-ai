...
* certify ordinary evaluation evidence and create immutable
  :class:`~whetstone.coordination.official.records.OfficialEvaluationRecord`
  values;
* publish immutable
  :class:`~whetstone.coordination.official.records.OfficialPlotManifest`
  values.
...
* an :class:`~whetstone.coordination.official.records.OfficialEvaluationRecord`
  will only
