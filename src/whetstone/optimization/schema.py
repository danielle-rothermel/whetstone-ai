...
from whetstone.optimization.effect_authority import TerminalOutcome
...
from whetstone.optimization.reward import RewardPolicy, RewardRef
from whetstone.optimization.tool_store import ToolCallState, ToolCallStoreEntry
...
class OptimizationStepResult(BaseModel):
    ...
    def _validate(self) -> OptimizationStepResult:
        ...
        request_candidate_refs = tuple(
            candidate_reference(candidate) for candidate in request.candidates
        )
