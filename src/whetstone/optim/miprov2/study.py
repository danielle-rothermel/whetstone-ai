...
class EvalObservation(_IdentityRecord):
    ...
    def identity_payload(self) -> dict[str, Any]:
        return {
            ...
            "eval_result_ref": self.eval_result_ref.model_dump(
                mode="json"
            ),
    ...
    @model_validator(mode="after")
    def _validate_evidence(self) -> EvalObservation:
        CandidateRef.model_validate(self.candidate.model_dump(mode="json"))
        EvalBinding.model_validate(
            self.eval_binding.model_dump(mode="json")
        )
        ...
        if self.eval_config != self.eval_binding.eval_config:
            raise ValueError(
...
class StudyTranscript(_IdentityRecord):
    ...
    def _validate_evaluation_binding(
        ...
        *,
        ...
        derivation = binding.eval_binding
...
class Miprov2Study:
    ...
    def initial_transcript(
        ...
        *,
        ...
        baseline_evaluation: EvalObservation,
    ) -> StudyTranscript:
    ...
    def record_sample(
        ...
        *,
        ...
        promotion_evaluation: EvalObservation | None = None,
    ) -> StudyTranscript:
    ...
    def _validate_evaluation_binding(
        ...
        *,
        ...
        request = binding.eval_binding.request
        if (
            request.control_identity_hash != self.optimizer_config.record_hash
            or request.source_eval_config != self.validation_eval_source
