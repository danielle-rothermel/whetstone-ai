...
ISSUED_TOOL_CALL_CLAIM_SCHEMA = "whetstone.optim_issued_tool_call_claim"
ISSUED_TOOL_CALL_SLOT_SCHEMA = "whetstone.optim_issued_tool_call_slot"
ISSUED_TOOL_CALL_TERMINAL_SCHEMA = (
    "whetstone.optim_issued_tool_call_terminal"
)
ISSUED_TOOL_CALL_KEY_SCHEMA = "whetstone.optim_issued_tool_call_key"
ISSUED_TOOL_CALL_KEY_SCHEMA_VERSION = 1
ISSUED_TOOL_CALL_KEY_PREFIX = "whetstone.optim_issued_tool_call:"
ISSUED_TOOL_CALL_SLOT_KEY_SCHEMA = (
    "whetstone.optim_issued_tool_call_slot_key"
)
ISSUED_TOOL_CALL_SLOT_KEY_SCHEMA_VERSION = 1
ISSUED_TOOL_CALL_SLOT_KEY_PREFIX = (
    "whetstone.optim_issued_tool_call_slot:"
)
ISSUED_TOOL_CALL_TERMINAL_KEY_SCHEMA = (
    "whetstone.optim_issued_tool_call_terminal_key"
)
