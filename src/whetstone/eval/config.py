...
SCHEMA_EVAL_PROCEDURE_DEFINITION = (
    "whetstone.eval_procedure.definition"
)
SCHEMA_EVAL_PROCEDURE_CONFIG = "whetstone.eval_procedure.config"
...
SCHEMA_SEED_PLAN = "whetstone.seed_plan"
SCHEMA_TASK_TRIAL_ID = "whetstone.task_trial_id"
...
class SamplingDefinition(_FrozenModel):
    ...
    variables: tuple[VariableSpec, ...] = (
        ...
        VariableSpec(name="seed_plan_hash"),
    )
...
class EvalProcedureDefinition(_FrozenModel):
    definition_id: str
    version: str
    variables: tuple[VariableSpec, ...] = (
        VariableSpec(
    ...
    def identity_hash(self) -> str:
        return _definition_config_hash(
            schema=SCHEMA_EVAL_PROCEDURE_DEFINITION,
            definition_id=self.definition_id,
            version=self.version,
            variables=self.variables,
            extra={},
    ...
    def ref(self) -> DefinitionRef:
        return DefinitionRef(
            definition_id=self.definition_id,
            version=self.version,
            schema_name=SCHEMA_EVAL_PROCEDURE_DEFINITION,
            identity_hash=self.identity_hash(),
        )
    ...
    def materialize(
        ...
        *,
        ...
        return EvalProcedureConfig._create(
            definition=self,
...
class EvalProcedureConfig(_FrozenModel):
    definition_ref: DefinitionRef
    ...
    def _create(
        ...
        *,
        ...
        config_hash = identity_hash_for(
            schema=SCHEMA_EVAL_PROCEDURE_CONFIG,
            payload={
                "definition_identity": definition.identity_hash(),
...
class EvalDefinition(_FrozenModel):
    ...
    def materialize(
        ...
        *,
        ...
        evaluation_procedure: EvalProcedureConfig,
