...
uv run --python 3.14 pytest -q -m pathway \
  'tests/pathways/sqlite_time/test_lease_renewal_pathway.py::test_success_and_failure_are_exact_immutable_and_replayed[memory]'
